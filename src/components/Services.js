...
const services = [
  {
    ...
    description:
      'Наши эксперты по налогам предоставляют консультации, направленные на оптимизацию налоговых обязательств и минимизацию налоговых рисков.',
  ...
  },
  {
    ...
    description:
      'Мы разрабатываем стратегии, которые помогут вашему бизнесу расти и эффективно конкурировать на рынке.',
  ...
  },
  {
    ...
    description:
      'Проводим глубокий финансовый анализ вашего бизнеса, предоставляя ценные инсайты для принятия обоснованных финансовых решений.',
        ...
        <Grid item xs={12} md={6}>
          <div>
            ...
            <Typography
              ...
              sx={{ mb: { xs: 2, sm: 4 } }}
            >
              Здесь вы можете ознакомиться с ключевыми услугами нашей компании. Мы предоставляем налоговый консалтинг, разрабатываем стратегии и проводим финансовый анализ для успешного развития вашего бизнеса.
            </Typography>
          </div>
